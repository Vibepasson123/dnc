...
<link href="{{asset('admincss/userMail/userMail.css')}}"rel="stylesheet" type="text/css">
<link href="{{asset('admincss/userMail/chatBox.css')}}"rel="stylesheet" type="text/css">
<style>
    .messsagebox{
        overflow-y: scroll;
        height:300px ;
...
<div class="right_col" role="main" >
  ...
  <div class="mail-box" >
        <aside class="sm-side" >
            ...
            <ul class="inbox-nav inbox-divider mailmenu " >
                <div>
                            ...
                            <form role="form" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-offset-2 col-lg-10">
                                        ...
                                        <button type="btn"  data-dismiss="modal"  class="btn btn-danger">Cancel</button>
                                    </div>
                                </div>
                            </form>
                        </div>
            ...
            <ul class="nav nav-pills nav-stacked labels-info online ">
                <li class=" text-center " id="online"> <h3 >Buddy online</h3>
                
                    
                </li>
                <li> <a href="#"> <i class=" fa fa-circle text-success"></i>Alireza Zare  
                      
                            <i class="fa fa-phone-square large pull-right" style="font-size:24px;color:green"></i>
                    
                     <p>I do not think</p></a>  </li>
                <li class="onlineuser"> <a href="#"> <i class=" fa fa-circle text-danger "></i>Dark Coders<p>Busy with coding</p></a> </li>
            ...
            <div class="inbox-head">
                ...
                <form action="#" class="pull-right position">
                    <div class="input-append">
                        <input type="text" class="sr-input" onkeyup="myFunction()" id="searchTable" placeholder="Search Mail">
               ...
               <table class="table table-inbox table-hover" id="mailTable">
                <tbody>
                  ...
                  <tr class="unread">
                      ...
                      <td class="view-message">Vmprove the search presence of WebSite</td>
      ...
      <script type="text/javascript">
        ...
        var button = document.querySelector('#mails');
        var menu = document.querySelector('.mailmenu');
        button.addEventListener('click', function (event) {
              if (menu.style.display == "") {
                  menu.style.display = "none";
                  button.innerHTML = "Mails";
              } else {
                  menu.style.display = "";
                  button.innerHTML = "Mails";
              }
         ...
         <script  src="{{ URL::asset('admincss/userMail/userMail.js') }}"></script>
         <script  src="{{ URL::asset('admincss/userMail/chatBox.js') }}"></script>
